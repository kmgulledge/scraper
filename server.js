// ========= Being White Belt Mongodb Coding =======
...
// ========== Configure Database ==================
mongoose.connect("mongodb://heroku_2prn6994:ki29dh8hgtp0mtf1ncuagvjgti@ds125113.mlab.com:25113/heroku_2prn6994");
var db = mongoose.connection;

db.on("error", function(err) {
    console.log("Oh no, Mongoose err'ed: ", err);
});

db.once("open", function() {
    console.log("Mongoose says way to connect with me.");
});
